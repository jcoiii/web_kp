...
<div class="collapse navbar-collapse justify-content-end " id="navbarSupportedContent">
   ...
   <br>
        <br>
 <h1 class="h3 mb-3 font-weight-normal">Tabel Data Mahasiswa</h1>     
<br>
...
<?php
 ...
 $table = "<table><tr><th>Kelompok</th><th>Nama Perusahaan</th><th>Nama Mahasiswa</th><th>NRP</th><th>Verifikasi Logbook</th></tr>";
 ...
 INNER JOIN mahasiswa ON kelompok_kp.kelompok = mahasiswa.kelompok) WHERE perusahaan.username='".$user."'");  
...
while ($row = $query->fetch_assoc())
{
    ...
    $submit1=   $row['nrpm'];
    $table .= '<td><form action="" method="POST" class="form-signin"><button class="btn btn-danger" type="$submit1" name="$submit1" value="Borang Verifikasi">Borang Verifikasi</button></form></td>';
    $table .= "</tr>";
}
