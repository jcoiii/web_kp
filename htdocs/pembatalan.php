                ...
                <span class="navbar-toggler-icon"></span>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                             ...
                             <li class="nav-item">
                                <a class="nav-link disabled" href="#">Logbook</a>
                             </li>              
...
<br>
  ...
  <form action="" method="POST">
     ...
     <div class="form-group mx-sm-5 mb-2">
      ...
      <input type="nama" class="col-4" id="nama" placeholder="Satria William" name=" nama">
    </div>
      
    <div class="form-group mx-sm-5 mb-2">
      <label for="npm">NPM Mahasiswa</label><br>
      <input type="npm" class="col-4" id="npm" placeholder="2015630002" name="npm">
    </div>
    ...
    <div class="form-group mx-sm-5 mb-2">
      ...
      <input type="perus" class="col-4" id="perus" placeholder="AeroTerraScan" name="perus">
    </div>
                                                                                           
    <div class="form-group mx-sm-5 mb-2">
      <label for="perus">Alasan Pembatalan</label><br>
      <input type="perus" class="col-4" id="perus" placeholder="Karena saya tidak kuat KP" name="perus">
    </div>                                                                                       
