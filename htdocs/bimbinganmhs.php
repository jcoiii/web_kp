...
<form action="" method="POST" class="form-signin">
     ...
     <br>
      <label for="inputhasil" class="sr-only">Status</label>
            <input type="text" id="hsl" class="form-control" placeholder="Status    " name="hsl" required="" autofocus="">
     <br>
...
{  
    ...
    $query=mysqli_query($con, "SELECT * FROM b$user"); 
